...
impl<I: Sharable> clb::Pullable<I> {
    pub fn iterate<O: Sharable>(self, f: fn(Self) -> (Self, clb::Pullable<O>)) -> clb::Pullable<O> {
        todo!()
    }
    ...
    pub fn map<O: Sharable>(self, f: fn(I) -> O) -> clb::Pullable<O> {
        todo!()
    }
    ...
    pub fn flat_map<O: Sharable>(self, f: fn(I) -> clb::Pullable<O>) -> clb::Pullable<O> {
        todo!()
    }

    pub fn reduce<O: Sharable>(self, f: fn(O, I) -> O) -> clb::Pullable<O> {
        todo!()
    }
